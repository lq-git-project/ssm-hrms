        ...
        <div class="hrms_main_ad col-sm-10">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 style="text-align: center;">欢迎进入圈圈圆圆公司人力资源管理系统！</h3>
                </div>
                <div class="panel-body" style="position:relative; top:-15px;">
                    <div id="hrms_carousel_1" class="carousel slide" data-ride="carousel">
                        <ol class="carousel-indicators">
                            ...
                            <li data-target="#hrms_carousel_1" data-slide-to="4"></li>
                            <li data-target="#hrms_carousel_1" data-slide-to="5"></li>
                            <li data-target="#hrms_carousel_1" data-slide-to="6"></li>
                        </ol>
                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="item">
                                <img class="img-responsive center-block" src="/static/img/beauty1.jpg" alt="company4">
                                <div class="carousel-caption">
                                    <h3>汪圆圆最喜欢的</h3>
                                </div>
                            </div>
                            <div class="item">
                                <img class="img-responsive center-block" src="/static/img/beauty2.jpg" alt="company5">
                                <div class="carousel-caption">
                                    <h3>汪圆圆最喜欢的</h3>
                                </div>
                            </div>
                            <div class="item">
                                <img class="img-responsive center-block" src="/static/img/beauty3.jpg" alt="company6">
                                <div class="carousel-caption">
                                    <h3>汪圆圆最喜欢的</h3>
                                </div>
                            </div>
                            <div class="item">
                                <img class="img-responsive center-block" src="/static/img/beauty4.jpg" alt="company7">
                                <div class="carousel-caption">
                                    <h3>汪圆圆最喜欢的</h3>
                                </div>
                            </div>
